        ...
        <div>
            <div style={{...styles.card , flexDirection:'column'}}>
                <div style={{...styles.logoContainer}}>
                    ...
                    <CreditCardOutlined style={{ fontSize:"200px",alignSelf:'center'}}/>
                    <p style={{textAlign:'center'}}>
                        After Clicking pay now you will be redirected to paystack to complete your payment securely
                    </p>
                    <PaystackButton className="btn btn-lg btn-success " {...componentProp} />
                </div>
            ...
            <div style={styles.container}>
                    ...
                    <p style={styles.content}><strong>Name:</strong> {name}</p>
                    <p style={styles.content}><strong>Email:</strong>{email}</p>
                    <p style={styles.content}><strong>Phone:</strong> {phone}</p>
